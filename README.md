...
* Under `FrequenciesVectors`, I changed the second hex from `0d000000` to `08000000` to enable a lowest frequency rate at 800MHz (although it probably should have been `09000000` to match my 6820HQ CPU);
