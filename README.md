...
4. __[Rare]__ The battery menubar icon does not appear on startup/reboot; adding `abm_firstpolldelay=16000` to boot arguments does not seem to fix the issue (it does so occasionally).
